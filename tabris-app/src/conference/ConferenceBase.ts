...

{
	...
	get tracks():OrderedSet<Track>{
		if(this._tracks===null){
			this._tracks = new OrderedSet<Track>(this, ConferencePackageLiterals.CONFERENCE_TRACKS, BasicEObjectImpl.EOPPOSITE_FEATURE_BASE - ConferencePackageLiterals.CONFERENCE_TRACKS);
